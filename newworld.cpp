...
int main(){  
    ...
    while(true){
	   ...
	   cout<<"['F' Fight] ['S' Switch] ['H' Heal] What will Player2 do?  ";
	    ...
	    else if(num1==1 or num1==2 or num1==3) selected_pokemon1[0].attack(selected_pokemon1[0].atk,num1,selected_pokemon2)
	    if(num2==0 or num2==5) swpoP(num2,selected_pokemon2);
	    else speedf(num1,num2,selected_pokemon1,selected_pokemon2);
	    cout<<"---------------------------------------\n";
}
}
